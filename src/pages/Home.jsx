          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-xl p-6 shadow-sm flex flex-col md:flex-row items-center gap-6">
              ...
              <div className="w-full md:w-2/3 text-right">
                ...
                <p className="text-gray-700 mb-4">ב-Printeam אנחנו משתמשים בשיטות מתקדמות ומבוקרות: רקמה, הדפסה במסך, הדפסה DTG/DTF וסובלימציה. לכל שיטה יש יתרונות ושימושים ספציפיים — נכין את ההדפסה המתאימה ביותר עבורך כדי להבטיח מראה מקצועי ועמידות ארוכת טווח.</p>
                <div className="flex justify-end">
                  <Link to="/methods-of-branding"><Button>למד עוד על שיטות המיתוג</Button></Link>
                </div>
              </div>
            </div>
          </div>
