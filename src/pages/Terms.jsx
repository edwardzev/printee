...
const Terms = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{t('termsTitle')} - Printeam</title>
        <meta name="description" content={`Read the ${t('termsTitle')} for Printeam.`} />
        <link rel="canonical" href="https://printeam.co.il/terms" />
      </Helmet>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="prose max-w-none text-gray-600">
              <p>
                ברוכים הבאים ל-Printeam. מסמך תנאי השימוש זה מגדיר את הכללים וההגבלות לשימוש באתר שלנו, הנמצא בכתובת printeam.co.il.
              </p>
              <p>
              ...
              <p>
                כל התכנים, העיצובים, הלוגואים והחומרים המוצגים באתר הינם בבעלות Printeam או מורשים לשימוש על ידה, ומוגנים על ידי דיני זכויות יוצרים ו/או זכויות קניין רוחני אחרות.
              </p>
              <p>
                זכויות יוצרים והגנה: כל הזכויות שמורות. אין להעתיק, לשכפל, לשדר, להפיץ, להציג בפומבי או ליצור עבודות נגזרות מכל חלק מהחומרים באתר ללא אישור בכתב ובמפורש של Printeam. כל שימוש לא מורשה ייחשב להפרה וייעשה בו שימוש בכל האמצעים המשפטיים העומדים לרשות החברה, לרבות דרישה לנזקים והוצאת צו מניעה.
              </p>
